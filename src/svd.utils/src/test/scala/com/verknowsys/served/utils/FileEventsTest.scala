...
// 2010-10-23 23:27:24 - dmilith - HACK: FIXME: XXX: NOTE: commented by me cause it fails and includes ugly hardcoded paths (non existant on other machines except Yours f.e.). Please use /tmp Luke and test it out Your code a bit more often ok? ;}
