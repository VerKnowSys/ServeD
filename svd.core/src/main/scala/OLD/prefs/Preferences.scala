...
//    "projectGroupId" -> "/svd",
//    "remoteProjectutilsDir" -> "/home/yout-user/project-utils-dir-on-remote-shell-accoun",
...
//      <remoteProjectutilsDir>{value("remoteProjectutilsDir")}</remoteProjectutilsDir>
...
//      map.update( "remoteProjectutilsDir", (node \ "remoteProjectutilsDir").text.trim)
