...
object SvdConfig {
    ...
    def watchServiceInterval            = 10000
    ...
    def vpnNetworkPreConfiguration      = "kldunload if_tap ; kldload if_tap ; ifconfig tap0 create ; ifconfig tap0 10.10.0.1 netmask 255.255.255.0"
