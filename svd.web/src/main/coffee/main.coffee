$ ->
  ...
  apiCalls = -> [
    ...
    {link: "CreateFileWatch", element: "div.create_file_watch", params: "CreateFileWatch=Src/index&Flags=3&ServiceName=Memcached" },
    {link: "CreateFileWatch", element: "div.create_file_watch1", params: "CreateFileWatch=Src/some2&Flags=3&ServiceName=Nginx" },
    {link: "CreateFileWatch", element: "div.create_file_watch2", params: "CreateFileWatch=Src/jakieśtakieśzótęłów&Flags=3&ServiceName=Mongodb" },
    {link: "CreateFileWatch", element: "div.create_file_watch3", params: "CreateFileWatch=Src/zdzibrub&Flags=3&ServiceName=RedisDrugi" },
